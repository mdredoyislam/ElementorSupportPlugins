 ...
 * Plugin URI:  https://redoyislam.xyz/elementortestplugin
 * Version:     1.0.0
 ...
 * @since 1.0.0
 */
final class ElementorTestPlugin {
	...
	public function register_new_category($manager){
		$manager->add_category('testcategory',[
			'title' => __( 'Test Category', 'picchi-extension' ),
	   		'icon' => 'fa fa-image', //default icon
		]);
	}
